...
public class Config : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage = "_ConfigGroupName", DbType = "NVarChar(255)")]
	public string ConfigGroupName
	{
		get
		{
			return _ConfigGroupName;
		}
		set
		{
			if (_ConfigGroupName != value)
			{
				SendPropertyChanging();
				_ConfigGroupName = value;
				SendPropertyChanged("ConfigGroupName");
			}
		}
	}
