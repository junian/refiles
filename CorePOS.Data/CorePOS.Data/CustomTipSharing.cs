...
[Table(Name = "dbo.CustomTipSharing")]
public class CustomTipSharing : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage = "_TipName", DbType = "NVarChar(128)")]
	public string TipName
	{
		...
		set
		{
			if (_TipName != value)
			{
				SendPropertyChanging();
				_TipName = value;
				SendPropertyChanged("TipName");
			}
		}
	}

	[Column(Storage = "_Percentage", DbType = "Decimal(10,2) NOT NULL")]
	...
	[Column(Storage = "_TipShareType", DbType = "SmallInt NOT NULL")]
	public short TipShareType
	{
		get
		{
			return _TipShareType;
		}
		set
		{
			if (_TipShareType != value)
			{
				SendPropertyChanging();
				_TipShareType = value;
				SendPropertyChanged("TipShareType");
			}
		}
	}
