...
[Table(Name = "dbo.Temp")]
public class Temp : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage = "_TempId", AutoSync = AutoSync.OnInsert, DbType = "BigInt NOT NULL IDENTITY", IsPrimaryKey = true, IsDbGenerated = true)]
	public long TempId
	{
		get
		{
	...
	[Column(Storage = "_Value", DbType = "Decimal(16,2) NOT NULL")]
