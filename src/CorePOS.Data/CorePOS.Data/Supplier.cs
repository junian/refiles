...
public class Supplier : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name = "Supplier_ItemsSupplier", Storage = "_ItemsSuppliers", ThisKey = "Id", OtherKey = "SupplierId")]
	...
	private void method_0(ItemsSupplier itemsSupplier_0)
	{
		SendPropertyChanging();
		itemsSupplier_0.Supplier = this;
	}

	private void method_1(ItemsSupplier itemsSupplier_0)
	{
		SendPropertyChanging();
		itemsSupplier_0.Supplier = null;
	}
